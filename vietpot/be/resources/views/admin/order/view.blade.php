...
$(document).on('click', '.edit_order_detail', function() {
	...
	$("#price_vat").val($(this).data('pricevat'));
...
function fill_datatable() {
	...
	$('#orderTable tbody').on('click', '.btn-show-tr', function() {
...
function sub_DataTable(table_id,record_id) {
	var subtable = $('table#'+table_id).DataTable({
		...
		"columns": [	
			...
			{ data: "total_products",sortable:true },
			{
				...
				sortable: false,
				"render": function(data, type, row, meta) {					
					return '<a href="javascript:void(0)" class="btn-show-tr1"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M10.0003 13.5C9.54495 13.5 9.09018 13.3245 8.74548 12.9798L3.31215 7.54648C3.29062 7.52495 3.27734 7.49422 3.27734 7.45837C3.27734 7.42251 3.29062 7.39178 3.31215 7.37025C3.33367 7.34873 3.36441 7.33545 3.40026 7.33545C3.43611 7.33545 3.46685 7.34873 3.48837 7.37025L8.92171 12.8036C9.51697 13.3988 10.4836 13.3988 11.0788 12.8036L16.5121 7.37025C16.5337 7.34873 16.5644 7.33545 16.6003 7.33545C16.6361 7.33545 16.6668 7.34873 16.6884 7.37025C16.7099 7.39178 16.7232 7.42251 16.7232 7.45837C16.7232 7.49422 16.7099 7.52495 16.6884 7.54648L11.255 12.9798C10.9103 13.3245 10.4556 13.5 10.0003 13.5Z" fill="#6D727B" stroke="#6D727B"/></svg></a>'
	...
	$('table#'+table_id).on('click', '.btn-show-tr1', function() {
		var tr = $(this).closest('tr');
...
function format1(table_id) {
	...
	'<th style="width: 160px">Số lượng/bịch/palet</th>'+
	'<th style="width: 160px">Giá trước thuế</th>'+
	'<th style="width: 160px">Giá sau thuế</th>'+
                ...
                <div class="modal-body">
                    <div class="wrap_form_modal">
						...
						<div class="form-group">
                            ...
                            <div class="group">
                                <input type="text" id="price_vat" class="form-control mask_number" value="0">
                            </div>
                        </div>
						...
						<table id="orderTable" class="table">
							<thead>
								<tr>
                                    ...
                                    <th scope="col">Tổng số tiền trước thuế</th>
                                    <th scope="col">Tổng số tiền sau thuế</th>
                                    <th scope="col">Số lượng bịch</th>
