		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Slide thông báo</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-store_notification-slide')}}" enctype="multipart/form-data">
		@csrf
		...
		<div class="row">
			<div class="col-12 col-lg-12">
				<div class="card">
					<div class="card-body">
					@include('admin.alert')
						<div class="btn btn btn-sm btn-brand m-btn m-btn--icon m-btn--pill m-btn--wide btn_upload_slide">
						...
						<div class="image_upload_multi_content row">
							...
							<div class="col-12 col-lg-3 image_insert_caption">
								...
								<input type="text" value="{{$item->url}}" name="list_slide_url[]" class="form-control" placeholder="URL" title="URL"/>
