		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Slide việc làm</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-store_opportunity-slide')}}" enctype="multipart/form-data">
		@csrf
