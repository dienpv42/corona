		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Slide hướng dẫn</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-store_howtoget-slide')}}" enctype="multipart/form-data">
		@csrf
