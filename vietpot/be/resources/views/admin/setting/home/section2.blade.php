								...
								<div class="row">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											foreach ($data as $key => $value) {
												if ($key == 'setting_home1_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home1_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home2_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home2_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>									
									<div class="col-6 col-lg-6">
										<div class="mb-3">
											<label class="form-label">Đăng ký ngay</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home5_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home5_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-6">
										<div class="mb-3">
											<label class="form-label">Link đăng ký ngay</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home6_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home6_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home3_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>		
											<input style="display:none" class="form-control file_upload_server_custom" id="label_setting_home3_section2_{{$item->id}}" type="file" data-id="setting_home3_section2_{{$item->id}}" data-url="{{route('dashboard-upload-one')}}" accept="image/*">
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_setting_home3_section2_{{$item->id}}">Upload file</label>
												{{Form::text('setting_home3_section2_'.$item->id,$value_lang,array('class'=>'form-control input-group-air ','id'=>'setting_home3_section2_'.$item->id))}}
											</div>
										</div>
									</div>
									<hr/>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home7_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home7_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home8_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home8_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-6">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home9_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home9_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-6">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home10_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home10_section2_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home11_section2_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>		
											<input style="display:none" class="form-control file_upload_server_custom" id="label_setting_home11_section2_{{$item->id}}" type="file" data-id="setting_home11_section2_{{$item->id}}" data-url="{{route('dashboard-upload-one')}}" accept="image/*">
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_setting_home11_section2_{{$item->id}}">Upload file</label>
												{{Form::text('setting_home11_section2_'.$item->id,$value_lang,array('class'=>'form-control input-group-air ','id'=>'setting_home11_section2_'.$item->id))}}
											</div>
										</div>
									</div>
								</div>
