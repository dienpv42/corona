								...
								<div class="row">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											foreach ($data as $key => $value) {
												if ($key == 'setting_home1_section3_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home1_section3_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label"> Text hỗ trợ</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home2_section3_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home2_section3_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home3_section3_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home3_section3_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-6">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home4_section3_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home4_section3_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-6 col-lg-6">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home5_section3_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home5_section3_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
								</div>
							</div>
