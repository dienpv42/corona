							...
							<div class="card-body">
								<div class="row">									
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Tài chính vững vàng Vạn sự an nhàn</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home3_section1_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home3_section1_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label"> Mở tài khoản nhanh - giao dịch ngay lập tức</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home4_section1_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home4_section1_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
								</div>
							</div>
