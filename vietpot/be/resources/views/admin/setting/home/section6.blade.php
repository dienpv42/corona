							...
							<div class="card-body">
								<div class="row">
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">APP TRUONGTIEN</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home1_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home1_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Kết nối tài chính dễ dàng hơn bao giờ hết</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home2_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home2_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Giao dịch ngay</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home3_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home3_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Tải ứng dụng trên App Store hoặc CH Play</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home4_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home4_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Đăng ký bằng số điện thoại và nhập mã OTP dược gửi về sms để hoàn tất đăng ký</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home5_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home5_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Điền tất cả những thông tin cần thiết để hoàn thiện hồ sơ</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home6_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home6_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Cài đặt ngay</label>	
											<?php
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home7_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home7_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home8_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>
											{{Form::text('setting_home8_section6_'.$item->id,$value_lang,array('class'=>'form-control'))}}						
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home9_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>		
											<input style="display:none" class="form-control file_upload_server_custom" id="label_setting_home9_section6_{{$item->id}}" type="file" data-id="setting_home9_section6_{{$item->id}}" data-url="{{route('dashboard-upload-one')}}" accept="image/*">
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_setting_home9_section6_{{$item->id}}">Upload file</label>
												{{Form::text('setting_home9_section6_'.$item->id,$value_lang,array('class'=>'form-control input-group-air ','id'=>'setting_home9_section6_'.$item->id))}}
											</div>
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											$value_lang = '';
											foreach ($data as $key => $value) {
												if ($key == 'setting_home10_section6_' . $item->id) {
													$value_lang = $value;
												}
											}
											?>		
											<input style="display:none" class="form-control file_upload_server_custom" id="label_setting_home10_section6_{{$item->id}}" type="file" data-id="setting_home10_section6_{{$item->id}}" data-url="{{route('dashboard-upload-one')}}" accept="image/*">
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_setting_home10_section6_{{$item->id}}">Upload file</label>
												{{Form::text('setting_home10_section6_'.$item->id,$value_lang,array('class'=>'form-control input-group-air ','id'=>'setting_home10_section6_'.$item->id))}}
											</div>
										</div>
									</div>
								</div>
