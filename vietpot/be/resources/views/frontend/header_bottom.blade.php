				...
				<div class="wrap_list_link_lb">
					<ul class="list_link_lb">
						<li class="list_link_item">
							<a href="data_admin.html" class="lb-small lb-link @if(isset($navigation) && $navigation=='admin') active @endif">
						...
						<li class="list_link_item">
							<a href="data_finance_accounting_invoice_add.html" class="lb-small lb-link @if(isset($navigation) && $navigation=='finance') active @endif">
						...
						<li class="list_link_item">
							<a href="data_report.html" class="lb-small lb-link @if(isset($navigation) && $navigation=='statistic') active @endif">
								{{App\Models\CommonModel::get_lang('setting_navigation7')}}
							</a>
						</li>
						<li class="list_link_item">
							<a href="data_customer_engagement.html" class="lb-small lb-link @if(isset($navigation) && $navigation=='contact') active @endif">
								{{App\Models\CommonModel::get_lang('setting_navigation8')}}
							</a>
						</li>
						<li class="list_link_item">
							<a href="data_send_report.html" class="lb-small lb-link @if(isset($navigation) && $navigation=='report') active @endif">
