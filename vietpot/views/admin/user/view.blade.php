...
$(".btn-add").click(function(){
	...
	$.ajax({
		...
		type: 'POST',
		dataType: 'json',
		data: {name:$("#name").val(),address:$("#eaddress").val(),email:$("#email").val(),group_user_id:$("#group_user_id").val(),phone:$("#phone").val(),password:$("#password").val(),gps:$("#egps").val()},	
...
function fill_datatable(filter_status = '') {
	...
	$('#partnerTable tbody').on('click', 'tr[data-id]', function() {
            ...
            <div class="modal-body">
                <div class="wrap_form_modal">
					...
					<div class="form-group">
                        ...
                        <div class="group">
                            <input type="text" class="form-control" value="" id="eaddress" placeholder="Search Box">
                        </div>
                    </div>
					<input id="egps" class="controls" type="hidden" value=""/>
					<div class="form-group">
