...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-add-page')}}" enctype="multipart/form-data">
		@csrf
		@include('admin.alert')
								...
								<div class="row">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											{{Form::textarea('content_'.$item->code,'',array('class'=>'form-control tinymce_editor','data-upload-url'=>route('dashboard-upload-temp')))}}
										</div>
									</div>									
								</div>
								<div class="row">
