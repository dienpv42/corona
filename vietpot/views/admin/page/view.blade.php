		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-news')}}">Trang tĩnh</a></li>
			...
			<div class="col-sm-6">
				...
				<div class="bookmark">
					<ul>
						<li><a href="{{route('add-page')}}" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="inbox"></i></a></li>
