...
function fill_datatable(filter_partner = []) {
	...
	$('#partnerTable tbody').on('click', '.btn-show-tr', function() {
		...
		let detailRow = '<tr class="details-row"><td colspan="8"><div id="productForm" class="wrap_tr_detail flex-p-16 wrap_tr_detail_4"><div class="w_tr_action"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalHistory" data-id="'+id+'" class="lb-xsmall history" data-type="price_no_vat">{{App\Models\CommonModel::get_lang("setting_product14")}}</a></div><div class="w_tr_action"><a href="javascript:void(0);" class="lb-xsmall">{{App\Models\CommonModel::get_lang("setting_product22")}}</a></div><div class="form-group d-flex flex-row align-items-center tr_item_4"><div class="form-label">{{App\Models\CommonModel::get_lang("setting_product20")}}</div><div class="group_input_btn"><input type="text" class="form-control note_'+id+'" placeholder="{{App\Models\CommonModel::get_lang("setting_product18")}}"><a href="javascript:void(0)" data-id="'+id+'" class="lb-xxsmall-primary product_note">{{App\Models\CommonModel::get_lang("setting_product19")}}</a></div></div><div class="w_tr_action_text"><a href="javascript:void(0)" data-id="'+id+'" data-bs-toggle="modal" data-bs-target="#modalEdit" class="lb-text-primary pedit">{{App\Models\CommonModel::get_lang("setting_product21")}}</a></div></div></td></tr>';
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{App\Models\CommonModel::get_lang("setting_product14")}}</h5>
            ...
            <div class="modal-body">
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr>
							  <th scope="col">{{App\Models\CommonModel::get_lang("setting_product15")}}</th>
							  <th scope="col">{{App\Models\CommonModel::get_lang("setting_product16")}}</th>
							  <th scope="col">{{App\Models\CommonModel::get_lang("setting_product17")}}</th>
							</tr>
						</thead>
                ...
                <div class="wrap_form_modal">
                    <div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_product8")}} <img src="" width="100px" id="img_eavatar"/>
                        </div>
                        <div class="group">
                    ...
                    <div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_product9")}}
                        </div>
                        <div class="group">
					...
					<div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_product7")}}
                        </div>
                        <div class="group">
                    ...
                    <div class="form-group">
                        <div class="form-label">
                           {{App\Models\CommonModel::get_lang("setting_product1")}}
                        </div>
                        <div class="group">
                    ...
                    <div class="form-group">
                        <div class="form-label">
                           {{App\Models\CommonModel::get_lang("setting_product3")}}
                        </div>
                        <div class="group">
					...
					<div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_product5")}}
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control mask_number" id="eprice_no_vat" value="0" aria-label="Text input with dropdown button">
							<input type="text" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" class="form-control" id="evat" value="0"/>
                            <button class="btn dropdown-toggle text-vat" type="button" data-bs-toggle="dropdown" aria-expanded="false">% {{App\Models\CommonModel::get_lang("setting_tax")}}</button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item dropdown-vat" data-id="evat" href="javascript:void(0)" data-value="0">{{App\Models\CommonModel::get_lang("setting_product10")}}</a></li>
                            </ul>
                        </div>
                    </div>   
					<div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_status")}}
                        </div>
                        <div class="group">
                            <select class="form-control" id="estatus">								
								<option value="0">{{App\Models\CommonModel::get_lang("setting_product11")}}</option>					
								<option value="1">{{App\Models\CommonModel::get_lang("setting_product12")}}</option>				
								<option value="2">{{App\Models\CommonModel::get_lang("setting_product13")}}</option>				
							</select>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="wrap_form_modal">
                    <div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_product8")}} <img src="" width="100px" id="img_avatar"/>
                        </div>
                        <div class="group">
					...
					<div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang("setting_product2")}}
                        </div>
                        <div class="group">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
							...
							<input type="text" class="form-control" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" id="vat" value="0"/>
                            <button class="btn dropdown-toggle text-vat" type="button" data-bs-toggle="dropdown" aria-expanded="false">% {{App\Models\CommonModel::get_lang("setting_tax")}}</button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item dropdown-vat" data-id="vat" href="javascript:void(0)" data-value="0">{{App\Models\CommonModel::get_lang("setting_product10")}}</a></li>
                            </ul>
                        </div>
                    </div>
					<div class="form-group">
				...
				<div class="wrap_content">
					<div class="wrap_table table-scroll table-responsive-lg">
						<table id="partnerTable" class="table">
							<thead>
								<tr>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product7")}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product4")}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product1")}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product2")}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product3")}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product5")}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang("setting_product6")}}</th>
									<th class="col"></th>
								</tr>
							</thead>
							<tbody>	
