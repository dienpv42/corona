	...
	<div class="page-header">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="bookmark">
					<ul>
						<li><a href="{{route('add-news-cate')}}" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="inbox"></i></a></li>
