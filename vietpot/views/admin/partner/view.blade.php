...
$(".btn-edit").click(function(){
	...
	$.ajax({
		url: "{{route('post-edit-partner')}}",
		type: 'POST',
		dataType: 'json',
		data: {id:$("#eid").val(),name:$("#ename").val(),description:$("#edescription").val(),avatar:$("#eavatar").val()},	
		success: function (msg, textStatus, jqXHR) {
			if(msg.check==0){
...
$(".btn-add").click(function(){
	...
	$.ajax({
		url: "{{route('post-add-partner')}}",
		type: 'POST',
		dataType: 'json',
		data: {name:$("#name").val(),description:$("#description").val(),avatar:$("#avatar").val()},	
		success: function (msg, textStatus, jqXHR) {
			if(msg.check==0){
				toastr.error(msg.content, ''); 
			}else{				
                ...
                <div class="wrap_form_modal">
                    <div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang('setting_partner1')}} <img src="" width="100px" id="img_eavatar"/>
                        </div>
                        <div class="group">
                    ...
                    <div class="form-group">
                        <div class="form-label">
                           {{App\Models\CommonModel::get_lang('setting_partner3')}}
                        </div>
                        <div class="group">
							<textarea class="form-control" id="edescription" rows="5"></textarea>
                        </div>
                    </div>                    
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="wrap_form_modal">
                    <div class="form-group">
                        <div class="form-label">
                            {{App\Models\CommonModel::get_lang('setting_partner1')}} <img src="" width="100px" id="img_avatar"/>
                        </div>
                        <div class="group">
			...
			<div class="wrap_head">
				<div class="wrap_list_link_lb wrap_list_link_lb_bd">
					<ul class="list_link_lb">
						...
						<li class="list_link_item">
							<a href="{{route('view-partner')}}" class="lb-xsmall lb-link active">
				...
				<div class="wrap_list_action wrap_list_action_bw">
					<a href="{{route('view-partner')}}" class="lb-xsmall">
						<span>
						...
						<table id="partnerTable" class="table">
							<thead>
								<tr>
									...
									<th scope="col">{{App\Models\CommonModel::get_lang('setting_partner4')}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang('setting_partner5')}}</th>
									<th scope="col">{{App\Models\CommonModel::get_lang('setting_partner6')}}</th>
									<th class="th-50"></th>
								</tr>
							</thead>
							<tbody>	
